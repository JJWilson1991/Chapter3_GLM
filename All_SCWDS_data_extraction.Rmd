...
Raw_CDV_All<- read_csv(here("data", "raw_data", "Master_CDV_samples.csv"))
Raw_CDV_All<-Raw_CDV_All[c(1:86),]
vis_miss(Raw_CDV_All)

#lets cut the irrelevant columns

filter1_CDV_All<-Raw_CDV_All[,c(4,5,7,9,10,12,13,17)]

```
```{r add months}
#convert date with lubridate and add individual d/m.y columns
filter1_CDV_All$`Date Rec.`%<>%mdy()
filter1_CDV_All<-filter1_CDV_All %>%
...
split_co <-  filter1_CDV_All%>% mutate(tosplit= as.character(Coordinates))
split_co2 <- split_co %>% separate(tosplit, c("lat", "long"), ",")
filter2_CDV_All<- split_co2 %>% mutate(lat = as.numeric(as.character(lat))) %>% mutate(long = as.numeric(as.character(long)))
```
```{r}
#knn all check
#code to extract data frame of lat/long points of cases for spdf
coordsall <- as.data.frame(structure(list(latitude = filter2_CDV_All$lat, longitude = filter2_CDV_All$long)))
#convert to spdf
SPDFall <- SpatialPointsDataFrame(c(coordsall[,c('longitude','latitude')]), data = coordsall)
...
proj4string(SPDFall) <- CRS("+init=epsg:4326")
SPDFall<-spTransform(SPDFall,epsg9311)
#check bbox
sf::st_bbox(SPDFall)
#plot(SPDF1)
```
...
Allknn1 <- knn( coordinates(SPDFall), coordinates(SPDFall), k=2)
  ( Allknn1 <- data.frame( knn=Allknn1[[1]][,2], knn.dist=Allknn1[[2]][,2] ) )

filter2_CDV_All<-cbind(filter2_CDV_All,Allknn1)
```

```{r elevation}
#get elevation data 
#add to SPDF
spdf_elev_epqsall <- get_elev_point(SPDFall, src = "epqs")
elevation_dfall<-data.frame(spdf_elev_epqsall$elevation)
#add to original DF
filter2_CDV_All<-cbind(filter2_CDV_All, elevation_dfall)
...
allppt_df<-data.frame(raster::extract(prism_ppt19, SPDFall))
filter2_CDV_All<-cbind(filter2_CDV_All,allppt_df)
```
```{r}
...
alltm_df<-data.frame(raster::extract(prism_tm19, SPDFall))
filter2_CDV_All<-cbind(filter2_CDV_All,alltm_df)
```

```{r}
#nest by state

nested_df<-filter2_CDV_All %>% 
  group_by(State) %>% 
  nest()

nested_df%<>%arrange(State)
```
...
#code to extract data frame of lat/long points of cases for spdf
coords1 <- as.data.frame(structure(list(latitude = nested_df[[2]][[1]]$lat, longitude = nested_df[[2]][[1]]$long)))
#convert to spdf
...
nested_df[[2]][[1]]<-  cbind(nested_df[[2]][[1]],extractLC1)
```
...
nested_df[[2]][[1]]<-cbind(nested_df[[2]][[1]], AR_water_m)
...
nested_df[[2]][[1]]<-cbind(nested_df[[2]][[1]],ARimp_df)
```
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords2 <- as.data.frame(structure(list(latitude = nested_df[[2]][[2]]$lat, longitude = nested_df[[2]][[2]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[2]]<-  cbind(nested_df[[2]][[2]],extractLC2)
```
...
nested_df[[2]][[2]]<-cbind(nested_df[[2]][[2]], FL_water_m)
...
nested_df[[2]][[2]]<-cbind(nested_df[[2]][[2]],FLimp_df)
```
###GEORGIA
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords3 <- as.data.frame(structure(list(latitude = nested_df[[2]][[3]]$lat, longitude = nested_df[[2]][[3]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[3]]<-  cbind(nested_df[[2]][[3]],extractLC3)
```
...
nested_df[[2]][[3]]<-cbind(nested_df[[2]][[3]], GA_water_m)
...
nested_df[[2]][[3]]<-cbind(nested_df[[2]][[3]],GAimp_df)
```
###KANSAS
```{r individual states}
#ARK_LA
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords4 <- as.data.frame(structure(list(latitude = nested_df[[2]][[4]]$lat, longitude = nested_df[[2]][[4]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[4]]<-  cbind(nested_df[[2]][[4]],extractLC4)
```
...
nested_df[[2]][[4]]<-cbind(nested_df[[2]][[4]], KS_water_m)
...
nested_df[[2]][[4]]<-cbind(nested_df[[2]][[4]],KSimp_df)
```
###KENTUCKY
```{r individual states}
#ARK_LA
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords5 <- as.data.frame(structure(list(latitude = nested_df[[2]][[5]]$lat, longitude = nested_df[[2]][[5]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[5]]<-  cbind(nested_df[[2]][[5]],extractLC5)
```
...
nested_df[[2]][[5]]<-cbind(nested_df[[2]][[5]], KY_water_m)
...
nested_df[[2]][[5]]<-cbind(nested_df[[2]][[5]],KYimp_df)
```
###LOUISIANA
```{r individual states}
#ARK_LA
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords6 <- as.data.frame(structure(list(latitude = nested_df[[2]][[6]]$lat, longitude = nested_df[[2]][[6]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[6]]<-  cbind(nested_df[[2]][[6]],extractLC6)
```
...
nested_df[[2]][[6]]<-cbind(nested_df[[2]][[6]], LA_water_m)
...
nested_df[[2]][[6]]<-cbind(nested_df[[2]][[6]],LAimp_df)
```
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords7 <- as.data.frame(structure(list(latitude = nested_df[[2]][[7]]$lat, longitude = nested_df[[2]][[7]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[7]]<-  cbind(nested_df[[2]][[7]],extractLC7)
```
...
nested_df[[2]][[7]]<-cbind(nested_df[[2]][[7]], MO_water_m)
...
nested_df[[2]][[7]]<-cbind(nested_df[[2]][[7]],MOimp_df)
```
###NORTH CAROLINA
```{r individual states}
#ARK_LA
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords8 <- as.data.frame(structure(list(latitude = nested_df[[2]][[8]]$lat, longitude = nested_df[[2]][[8]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[8]]<-  cbind(nested_df[[2]][[8]],extractLC8)
```
...
nested_df[[2]][[8]]<-cbind(nested_df[[2]][[8]], NC_water_m)
...
nested_df[[2]][[8]]<-cbind(nested_df[[2]][[8]],NCimp_df)
```
...
```{r extract coords for spdf}
#code to extract data frame of lat/long points of cases for spdf
coords9 <- as.data.frame(structure(list(latitude = nested_df[[2]][[9]]$lat, longitude = nested_df[[2]][[9]]$long)))
#convert to spdf
...
#need to add back to original DF
nested_df[[2]][[9]]<-  cbind(nested_df[[2]][[9]],extractLC9)
```
...
nested_df[[2]][[9]]<-cbind(nested_df[[2]][[9]], NE_water_m)
...
nested_df[[2]][[9]]<-cbind(nested_df[[2]][[9]],NEimp_df)
```
###TENNESSEE
```{r individual states}
#ARK_LA
